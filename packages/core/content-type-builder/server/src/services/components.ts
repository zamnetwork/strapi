...
export const createComponent = async ({ component, components = [] }: any) => {
  ...
  strapi.get('eventHub').emit('component.create', { component: newComponent });
...
export const editComponent = async (
  ...
  strapi.get('eventHub').emit('component.update', { component: updatedComponent });
...
export const deleteComponent = async (uid: UID.Component) => {
  ...
  strapi.get('eventHub').emit('component.delete', { component: deletedComponent });
